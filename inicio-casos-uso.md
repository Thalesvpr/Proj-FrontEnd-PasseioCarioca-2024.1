...
- P.2: O visitante localiza o link ou botão para download do aplicativo, localizado no cabeçalho ou em destaque em seções da página.
...
- O visitante é redirecionado para a página de download do aplicativo, onde pode visualizar informações adicionais sobre o aplicativo e iniciar o processo de download e instalação.
...
- 
======= apresentar aplicativo(textos e s)
...
# 1.3 Caso de Uso: Explore o Aplicativo
